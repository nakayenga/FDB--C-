...
--SELECT
--	@RUNDATE AS EFFECTIVE_DATE,
--	'SUNG' AS ENTRY_CODE,
--	CASE WHEN LEN(MONTH(@RUNDATE)) = 1 THEN '=' + '"0' + CAST(MONTH(@RUNDATE) AS CHAR(1)) + '"' 
--		 ELSE '=' + '"' + CAST(MONTH(@RUNDATE) AS CHAR(2)) + '"' END AS MONTH,
--	'=' + '"' + CAST(YEAR(@RUNDATE) AS CHAR(4)) + '"' AS YEAR,
